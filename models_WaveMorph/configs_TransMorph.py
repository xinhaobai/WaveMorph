...
def get_3DTransMorph_embed48_config():
    '''
    Trainable params: 15,201,579
    '''
    config = ml_collections.ConfigDict()
...
def get_3DTransMorphSmall_config():
    ...
    config.drop_path_rate = 0.3 #0.3
    config.ape = False#False
    config.spe = False
    config.rpe = True
    config.patch_norm = True
    config.use_checkpoint = False
...
# 96x96x96
def get_3DTransMorphSmall96_config():
    '''
    A Small TransMorph Network
    '''
    config = ml_collections.ConfigDict()
    ...
    config.depths = (2, 2, 4, 2)
    config.num_heads = (4, 4, 4, 4)
    config.window_size = (3,3,3)#(5, 6, 7)#(4,5,6)
    config.mlp_ratio = 4
    config.pat_merg_rf = 4
    config.qkv_bias = False
    config.drop_rate = 0#0
    ...
    config.reg_head_chan = 16
    # config.img_size = (160, 192, 224)
    config.img_size = (96,96,96) #(96,96,128) # xh
    return config


# 128x128x128
def get_3DTransMorphSmall128_config():
    '''
    A Small TransMorph Network
    '''
    config = ml_collections.ConfigDict()
    ...
    config.depths = (2, 2, 4, 2)
    config.num_heads = (4, 4, 4, 4)
    config.window_size = (4,4,4) #(5, 6, 7)
    config.mlp_ratio = 4
    config.pat_merg_rf = 4
    config.qkv_bias = False
    config.drop_rate = 0#0
    ...
    config.out_indices = (0, 1, 2, 3)
    config.reg_head_chan = 16
    config.img_size = (128,128,128) # xh
    return config

# 128x128x128
def get_3DTransMorphSmall128160128_config():
    '''
    A Small TransMorph Network
    '''
    config = ml_collections.ConfigDict()
    ...
    config.patch_size = 4
    config.in_chans = 2
    config.embed_dim = 48# 96
    config.depths = (2, 2, 4, 2)
    config.num_heads = (4, 4, 4, 4)
    config.window_size = (4,5,4) #(5, 6, 7)
    config.mlp_ratio = 4
    config.pat_merg_rf = 4
    config.qkv_bias = False
    config.drop_rate = 0#0
    ...
    config.out_indices = (0, 1, 2, 3)
    config.reg_head_chan = 16
    config.img_size = (128,160,128) #(96,96,128) # xh
    return config



def get_3DWaveMorph_128160128_config():
...
def get_3DWaveMorph_128128128_config():
    config = ml_collections.ConfigDict()
    config.if_transskip = True
    config.if_convskip = True
    config.patch_size = 4
    ...
    config.out_indices = (0, 1, 2, 3)
    config.reg_head_chan = 16
    config.img_size = (128, 128, 128) #(96,96,128) # xh
    return config



def get_3DWaveMorph_128160larg_config():
...
def get_3DWaveMorph_128160small_config():
...
# 160x160x160
def get_3DTransMorphSmall160_config():
    '''
    A Small TransMorph Network
    '''
    config = ml_collections.ConfigDict()
    ...
    config.reg_head_chan = 16
    # config.img_size = (160, 192, 224)
    config.img_size = (160,160,160) #(96,96,128) # xh
    return config
