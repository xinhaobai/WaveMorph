...
# todo: referenced form: https://github.com/pfriedri/wdm-3d/blob/main/DWT_IDWT/DWT_IDWT_Functions.py
...
class DWTFunction_3D(Function):
    ...
    def forward(ctx, input,
        ...
        return LLL, LLH, LHL, LHH, HLL, HLH, HHL, HHH # org
        # return   torch.cat([LLL, LLH, LHL, LHH, HLL, HLH, HHL, HHH], dim=1)# xh
