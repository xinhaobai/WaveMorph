...
class DWT_3D(Module):
    ...
    def forward(self, input):
        ...
        return DWTFunction_3D.apply(input,
                                    self.matrix_low_0[i].to(input.device), # xh
                                    self.matrix_low_1[i].to(input.device),
                                    self.matrix_low_2[i].to(input.device),
                                    self.matrix_high_0[i].to(input.device),
                                    self.matrix_high_1[i].to(input.device),
                                    self.matrix_high_2[i].to(input.device)
                                    )
...
class IDWT_3D(Module):
    ...
    def forward(self, LLL, LLH, LHL, LHH, HLL, HLH, HHL, HHH):
        ...
        return IDWTFunction_3D.apply(LLL, LLH, LHL, LHH, HLL, HLH, HHL, HHH,
                                     self.matrix_low_0[i].to(LLL.device), # xh
                                     self.matrix_low_1[i].to(LLL.device),
                                     self.matrix_low_2[i].to(LLL.device),
                                     self.matrix_high_0[i].to(LLL.device),
                                     self.matrix_high_1[i].to(LLL.device),
                                     self.matrix_high_2[i].to(LLL.device)
                                     )
